...
# No threat model: bastion holds no secret, stores nothing, and makes no trust
# decision. Its failure modes are availability ones, and they are requirements
# rather than threats. If it ever grows one, set the path here and the checks
# switch on.
THREAT_MODEL_FILE=""
ADR_DIR="docs/adr"
ID_PREFIXES="FR|NFR|IR"
# ---------------------------------------------------------------------------
